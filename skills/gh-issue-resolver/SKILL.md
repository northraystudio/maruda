...
| batch | the epic branch, passed in by `gh-batch-runner` |
...
```
/maruda:data-validation <changed-data-scope>   # baseline: <base-ref>
```
...
```
/maruda:data-validation <changed-data-scope>     # baseline: <base-ref>
/maruda:vulnerability-scan <changed-path>
/maruda:software-evaluation <changed-path>
```
