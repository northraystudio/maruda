...
description: >
  ...
  "sync documentation", "update architecture docs", "/maruda:spec-doc", or when asked to document
...
To update this spec: run `/maruda:spec-doc [module path]` after significant code changes.
